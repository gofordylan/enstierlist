...
const ITEMS = [
  {
    ...
    body: "Type a .eth name in the send field and it resolves to the right address.",
  },
  {
    key: "reverse",
    title: "Reverse Resolution",
    body: "When an address appears in an app/wallet, it displays the primary .eth name instead of the raw address.",
  },
  {
    key: "avatar",
    title: "Avatar",
    body: "The ENS avatar renders as the profile picture for that account or counterparty.",
  },
  {
    key: "offchain",
    title: "CCIP-Read names",
    body: "The app/wallet resolves names that are stored outside of Ethereum mainnet.",
  },
];
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-5 flex flex-col gap-5 text-[15px] leading-relaxed text-[var(--color-mute)]">
          <p>
            Each wallet or dApp is scored on four binary criteria. Score 4/4 = <span className="text-paper font-semibold">S</span>,
